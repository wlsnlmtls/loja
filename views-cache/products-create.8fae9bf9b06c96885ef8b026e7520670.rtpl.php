  	...
  	<div class="col-md-12">
        ...
        <script>
          function change(element){
            document.getElementById("desurl").value = element.value.split(" ").join("-").split(".").join("-").toLowerCase();
          }
        </script>
        <form role="form" action="/admin/products/create" method="post">
          <div class="box-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" onkeyup="change(this)" id="desproduct" name="desproduct" placeholder="Digite o nome do produto">
            </div>
            <div class="form-group">
